...
namespace Intertoll.TollDataImport.DataRequest.Managers
{
    public static class LookupManager
    {
        ...
        public static string Lanes(int LaneID)
        {
            var laneCode = "";
            try
            {
                Dictionary<int, string> dictionary = new Dictionary<int, string>();
                dictionary.Add(1,"01MS");
                dictionary.Add(2,"02MS");
                dictionary.Add(3,"03MS");
                dictionary.Add(4,"04MS");
                dictionary.Add(5,"05MS");
                dictionary.Add(6,"06MS");
                dictionary.Add(8,"08MS");
                dictionary.Add(9,"09MS");
                dictionary.Add(10,"10MS");
                dictionary.Add(11,"11MN");
                dictionary.Add(12,"12MN");
                dictionary.Add(13,"13MN");
                dictionary.Add(14,"14MN");
                dictionary.Add(15,"15MN");
                dictionary.Add(16,"16MN");
                dictionary.Add(17,"17MN");
                dictionary.Add(18,"18MN");

                if (dictionary.ContainsKey(LaneID) == true)
                {
                    laneCode = dictionary[LaneID];
                }
            }
            catch (Exception ex)
            {
        ...
        public static List<PaymentGroupsMapping> PaymentGroupsMappings()
        {
            ...
            {
                return dc.PaymentGroupsMappings.Get().ToList();
            }
        }
        ...
        public static List<PaymentMechMapping> PaymentMechsMapping()
        {
            using (PCSStagingDataContext dc = new PCSStagingDataContext())
            {
                return dc.PaymentMechMappings.Get().ToList();
            }
        }
        ...
        public static List<PaymentMethodsMapping> PaymentMethodsMapping()
        {
            using (PCSStagingDataContext dc = new PCSStagingDataContext())
            {
                return dc.PaymentMethodsMappings.Get().ToList();
            }
        }
        ...
        */
        ...
        public static Guid? MappedClass(this int? ClassCode)
        {
            return ClassCode.HasValue ? Classes(ClassCode.Value) :  (Guid?) null;
        }

        public static Guid MappedPaymentGroup(this int? Code)
        {
            return PaymentGroupsMappings().First(x => x.PaymentGroupCode == Code).PaymentGroupGUID;
        }

        public static Guid MappedPaymentMech(this int? Code)
        {
            return PaymentMechsMapping().First(x => x.PaymentMechCode == Code).PaymentMechGUID;
        }

        public static Guid MappedPaymentMethod(this int? Code)
        {
            return PaymentMethodsMapping().First(x => x.PaymentMethodCode == Code).PaymentMethodGUID;
        }

        public static Guid MappedPaymentType(this int? Code)
        {
            return PaymentTypesMapping().First(x => x.PaymentTypeCode == Code).PaymentTypeGUID;
        }

        public static Guid MappedTariff(this int? VirtualPlazaID,int? ClassCode, int TariffPlanID)
        {
            return TariffMapping().FirstOrDefault(x => x.VirtualPlazaID == VirtualPlazaID && x.ClassCode == ClassCode &&
                                                       x.TollTariffPlanID == TariffPlanID)
                                  .TariffGuid;
        }
